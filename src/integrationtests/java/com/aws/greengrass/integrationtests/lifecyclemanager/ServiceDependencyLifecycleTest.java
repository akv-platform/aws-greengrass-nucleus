...
class ServiceDependencyLifecycleTest extends BaseITCase {
    ...
    private static final int TEST_ROUTINE_SHORT_TIMEOUT = 3000;
    private static final int TEST_ROUTINE_MEDIUM_TIMEOUT = 4000;
    private static final int TEST_ROUTINE_LONG_TIMEOUT = 6000;
